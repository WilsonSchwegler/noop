 ...
 *     clash with the Room entity net.wilsonschwegler.warbfit.data.SleepSession.
 ...
 * net.wilsonschwegler.warbfit.data layer; the Swift source uses Int seconds.
 *
 ...
 * entity net.wilsonschwegler.warbfit.data.SleepSession. Mirrors Swift `SleepSession` (the analytics
 ...
 *
 * NOTE: [daily] is the Room entity net.wilsonschwegler.warbfit.data.DailyMetric (cache shape, with
 * recovery/strain/sleep rolled up). The detected sleep sessions are the analytics
 * [DetectedSleep] shape; persistence to net.wilsonschwegler.warbfit.data.SleepSession rows is wired
...
data class DayResult(
    ...
    val daily: net.wilsonschwegler.warbfit.data.DailyMetric,
