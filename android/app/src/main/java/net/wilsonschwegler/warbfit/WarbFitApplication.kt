 ...
 *
 * WarbFit is a fully on-device TRACKER companion: it connects to the strap over BLE and
 * persists everything locally via Room. There is no network layer.
 *
 * This class is intentionally thin. The BLE client ([net.wilsonschwegler.warbfit.ble.TrackerBleClient]) and
 * the data layer ([net.wilsonschwegler.warbfit.data.TrackerRepository]) are owned and held by the
