...
// MARK: - Metrics (ported from StrandDesign/Components.swift WarbFitMetrics)
...
private val WarbFitColorScheme = darkColorScheme(
...
private val WarbFitMaterialTypography = Typography(
    displayLarge = WarbFitType.display(72f),
    titleLarge = WarbFitType.title1,
    titleMedium = WarbFitType.title2,
    titleSmall = WarbFitType.headline,
    bodyLarge = WarbFitType.body,
    bodyMedium = WarbFitType.subhead,
    bodySmall = WarbFitType.caption,
    labelLarge = WarbFitType.headline,
    labelMedium = WarbFitType.caption,
    labelSmall = WarbFitType.overline,
)

private val WarbFitShapes = Shapes(
...
/**
 * WarbFitTheme — dark, instrument-grade. Always dark regardless of system setting
 ...
 */
@Composable
fun WarbFitTheme(content: @Composable () -> Unit) {
    ...
    isSystemInDarkTheme()
    MaterialTheme(
        colorScheme = WarbFitColorScheme,
        typography = WarbFitMaterialTypography,
        shapes = WarbFitShapes,
        content = content,
    )
}
