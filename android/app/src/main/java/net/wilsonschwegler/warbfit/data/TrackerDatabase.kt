 ...
 * Packages/TrackerStore (Database.swift schema). Holds phone-collected raw streams
...
abstract class TrackerDatabase : RoomDatabase() {
    ...
    companion object {
        const val DB_NAME = "warbfit_tracker.db"
        ...
        private fun build(appContext: Context): TrackerDatabase =
            Room.databaseBuilder(appContext, TrackerDatabase::class.java, DB_NAME)
