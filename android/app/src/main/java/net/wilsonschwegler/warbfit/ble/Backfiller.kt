...
import net.wilsonschwegler.warbfit.protocol.classifyHistoricalMeta
import net.wilsonschwegler.warbfit.protocol.extractHistoricalStreams
...
class PrefsTrimCursorStore(context: Context) : TrimCursorStore {
    private val prefs = context.applicationContext
        .getSharedPreferences("warbfit_backfill_cursors", Context.MODE_PRIVATE)
