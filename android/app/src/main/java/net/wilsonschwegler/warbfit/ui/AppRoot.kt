    ...
    ModalNavigationDrawer(
                    ...
                    drawerGroups.forEachIndexed { index, group ->
                        ...
                        group.items.forEach { dest ->
                            ...
                            NavigationDrawerItem(
                                ...
                                label = { Text(dest.title, style = WarbFitType.body) },
        ...
        Scaffold(
            ...
            topBar = {
                TopAppBar(
                    title = {
                        Text(current.title, style = WarbFitType.title2, color = Palette.textPrimary)
                    },
                    navigationIcon = {
    ...
    Column(
        ...
        WarbFitCard(padding = 28.dp) {
            Column(
                ...
                Text(text, style = WarbFitType.title2, color = Palette.textPrimary, textAlign = TextAlign.Center)
