 ...
 * the Room entities net.wilsonschwegler.warbfit.data.HrSample (ts:Long seconds, bpm:Int) and
 * net.wilsonschwegler.warbfit.data.GravitySample (ts:Long seconds, x/y/z:Double). All `ts`/`start`/`end`
