...
enum class DeviceFamily {
    ...
    val headerCRCKind: HeaderCRCKind
        get() = when (this) {
            TRACKER4 -> HeaderCRCKind.CRC8
            TRACKER5 -> HeaderCRCKind.CRC16_MODBUS
        }

    /** Primary GATT service UUID *string* for this family (lowercase, as advertised). */
    val serviceUuidString: String
        get() = when (this) {
            TRACKER4 -> "61080001-8d6d-82b8-614a-1c8cb0f8dcc6"
            TRACKER5 -> "fd4b0001-cce1-4033-93ce-002d5875f58a"
        }
    ...
    val commandCharacteristicUuidString: String
        get() = when (this) {
            TRACKER4 -> "61080002-8d6d-82b8-614a-1c8cb0f8dcc6"
            TRACKER5 -> "fd4b0002-cce1-4033-93ce-002d5875f58a"
        }
...
/**
 * Tracker 5.0 "puffin" packet types mirror existing 4.0 types on the new transport. These map onto
