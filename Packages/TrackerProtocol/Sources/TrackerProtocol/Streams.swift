...
// Phase E and TrackerStore depend on these EXACT shapes. ts is wall-clock unix seconds
...
public struct TrackerEvent: Equatable, Codable {
...
public struct Streams: Equatable, Codable {
    ...
    public init(hr: [HRSample] = [], rr: [RRInterval] = [],
                ...
                events: [TrackerEvent] = [], battery: [BatterySample] = []) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        events = try c.decodeIfPresent([TrackerEvent].self, forKey: .events) ?? []
...
public func extractStreams(_ parsed: [ParsedFrame],
    ...
    for r in parsed {
        ...
        case "EVENT":
            ...
            out.events.append(TrackerEvent(ts: ts, kind: kind, payload: payload))
