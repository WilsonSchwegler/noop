...
final class ReadTests: XCTestCase {
    private func seeded() async throws -> TrackerStore {
        ...
        let s = Streams(
            ...
            events: [TrackerEvent(ts: 150, kind: "BLE_CONNECTION_DOWN(12)",
                                payload: ["k": .int(9)])],
    ...
    func testEventsDecodePayload() async throws {
        ...
        XCTAssertEqual(evs, [TrackerEvent(ts: 150, kind: "BLE_CONNECTION_DOWN(12)",
                                        payload: ["k": .int(9)])])
    }
